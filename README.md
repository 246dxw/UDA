...
| ------------------------------------------------------------ | ------------------------------------------------------------ | --------------------------------------------------------- | --------- |
| Revisiting Source-Free Domain Adaptation: Insights into Representativeness, Generalization, and Variety | [CVPR2025]()                                                 |                                                           |           |
| ADU: Adaptive Detection of Unknown Categories in Black-Box Domain Adaptation | [CVPR2025]()                                                 |                                                           |           |
...
| Distinguish Then Exploit: Source-free Open Set Domain Adaptation via Weight Barcode Estimation and Sparse Label Assignment | [CVPR2025]()                                                 |                                                           |           |
| ONDA-Pose: Occlusion-Aware Neural Domain Adaptation for Self-Supervised 6D Object Pose Estimation | [CVPR2025]()                                                 |                                                           |           |
| SemiDAViL: Semi-supervised Domain Adaptation with Vision-Language Guidance for Semantic Segmentation | [CVPR2025]()                                                 |                                                           |           |
| Universal Domain Adaptation for Semantic Segmentation        | [CVPR2025]()                                                 |                                                           |           |
| Preserving Clusters in Prompt Learning for Unsupervised Domain Adaptation | [CVPR2025]()                                                 |                                                           |           |
| MODfinity: Unsupervised Domain Adaptation with Multimodal Information Flow Intertwining | [CVPR2025]()                                                 |                                                           |           |
| Link-based Contrastive Learning for One-Shot Unsupervised Domain Adaptation | [CVPR2025]()                                                 |                                                           |           |
| Learning to Adapt Frozen CLIP for Few-Shot Test-Time Domain Adaptation | [ICLR2025]()                                                 |                                                           |           |
| Enhancing Federated Domain Adaptation with Multi-Domain Prototype-Based Federated Fine-Tuning | [ICLR2025]()                                                 |                                                           |           |
| Mix-CPT: A Domain Adaptation Framework via Decoupling Knowledge Learning and Format Alignment | [ICLR2025]()                                                 |                                                           |           |
| On the Benefits of Attribute-Driven Graph Domain Adaptation  | [ICLR2025]()                                                 |                                                           |           |
| Proxy Denoising for Source-Free Domain Adaptation            | [ICLR2025]()                                                 |                                                           |           |
| Auto-GDA: Automatic Domain Adaptation for Efficient Grounding Verification in Retrieval-Augmented Generation | [ICLR2025]()                                                 |                                                           |           |
...
| What Has Been Overlooked in Contrastive Source-Free Domain Adaptation: Leveraging Source-Informed Latent Augmentation within Neighborhood Context | [ICLR2025]()                                                 |                                                           |           |
| A General Representation-Based Approach to Multi-Source Domain Adaptation | [ICML2025]()                                                 |                                                           |           |
| Concept-Based Unsupervised Domain Adaptation                 | [ICML2025]()                                                 |                                                           |           |
| COSDA: Counterfactual-based Susceptibility Risk Framework for Open-Set Domain Adaptation | [ICML2025]()                                                 |                                                           |           |
| Disentangled Graph Spectral Domain Adaptation                | [ICML2025]()                                                 |                                                           |           |
| Homophily Enhanced Graph Domain Adaptation                   | [ICML2025]()                                                 |                                                           |           |
| Merge-Friendly Post-Training Quantization for Multi-Target Domain Adaptation | [ICML2025]()                                                 |                                                           |           |
| Sparse Causal Discovery with Generative Intervention for Unsupervised Graph Domain Adaptation | [ICML2025]()                                                 |                                                           |           |
| SynEVO: A neuro-inspired spatiotemporal evolutional framework for cross-domain adaptation | [ICML2025]()                                                 |                                                           |           |
| Tackling Dimensional Collapse toward Comprehensive Universal Domain Adaptation | [ICML2025]()                                                 |                                                           |           |
| Theoretical Performance Guarantees for Partial Domain Adaptation via Partial Optimal Transport | [ICML2025]()                                                 |                                                           |           |
...
| Smoothness Really Matters: A Simple Yet Effective Approach for Unsupervised Graph Domain Adaptation | [AAAI2025](https://ojs.aaai.org/index.php/AAAI/article/view/33743) | [TDSS](https://github.com/cwei01/TDSS)                    |           |
| Vox-UDA: Voxel-wise Unsupervised Domain Adaptation for Cryo-Electron Subtomogram Segmentation with Denoised Pseudo-Labeling | [AAAI2025](https://ojs.aaai.org/index.php/AAAI/article/view/32019) | [Vox-UDA](https://github.com/xulabs/aitom))               |           |
